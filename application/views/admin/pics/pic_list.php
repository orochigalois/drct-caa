<div class="mrbot">
    <div class="mrbot1">
        ...
        <div class="mrnr1">
                ...
                <div class="hdtop">
                    <a href="<?=site_url('admin/pics/picEdit?cateid='.$cateid)?>" class="tja">添 加</a>
                    <a href="<?=site_url('admin/pics/picList?cateid='.$cateid)?>" class="gla">管 理</a>
                    <a href="<?=site_url('admin/pics?cateid='.$pid)?>" class="gla" style="margin-left:10px;">返回</a>
                    <form name="myform" action="<?=site_url('admin/pics/picList')?>" method="get">
                ...
                <form action="<?=site_url('admin/pics/picDel')?>" method="post" onSubmit="return checkSubmit(this);">
                <div class="hdbot">
                    <table width="910" border="0" cellspacing="1" cellpadding="0" class="table1 tab">
                      ...
                      <tr>
                        ...
                        <td align="center"><a href="<?=site_url('admin/pics/picEdit?cateid='.$cateid.'&id='.$c['id'])?>" class="xga">修改</a></td>
                      </tr>
                      <?php endforeach;?>
