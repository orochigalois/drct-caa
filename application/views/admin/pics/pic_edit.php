<div class="mrbot">
    <div class="mrbot1">
        ...
        <div class="mrnr1">
                <div class="hdtop">
                    <a href="<?=site_url('admin/news/picEdit?cateid='.$cateid)?>" class="tja">添 加</a>
                    <a href="<?=site_url('admin/news/picList?cateid='.$cateid)?>" class="gla">管 理</a>
                    <a href="<?=site_url('admin/pics?cateid='.$pid)?>" class="gla" style="margin-left:10px;">返回</a>
                    <div class="clear"></div>
                </div>
                <div class="zxzx_main">
                	<form name="myform"  method="post" action="<?=site_url('admin/pics/picSave')?>" class="addForm">
                    <table class="table7 table77" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            ...
                            <td>
                         	  ...
                         	  <input name="Submit2" type="button" class="button1" onclick="uploadpic('simg',948,587)" value="上传" />图片建议尺寸948*587px;
                            </td>
                        </tr>
                        <tr>
