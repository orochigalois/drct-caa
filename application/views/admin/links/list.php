<div class="mrbot">
    <div class="mrbot1">
        ...
        <div class="mrnr1">
                <div class="hdtop">
                    <a href="<?=site_url('admin/links/edit')?>" class="tja tja2">添加</a>
                    <a href="<?=site_url('admin/links')?>" class="gla gla2">管理</a>                    
                    <div class="clear"></div>
                </div>
                <div class="hdbot">
                	 <form action="<?=site_url('admin/links/moreDel')?>" method="post" onSubmit="return checkSubmit(this);">
                    ...
                    <table width="910" border="0" cellspacing="1" cellpadding="0" class="table1 tab">
                      ...
                      <tr>
                        ...
                        <td align="center"><a href="<?=site_url('admin/links/edit'.'?id='.$c['id'])?>" class="xga">修改</a></td>
                      </tr>
                      <?php endforeach;?>
                    </table>
                    <div class="tableb">
