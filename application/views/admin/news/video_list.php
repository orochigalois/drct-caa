<div class="mrbot">
    <div class="mrbot1">
        ...
        <div class="mrnr1">
                ...
                <div class="hdtop">
                    <a href="<?=site_url('admin/news/VideoEdit?cateid='.$cateid)?>" class="tja">添 加</a>
                    <a href="<?=site_url('admin/news/VideoList?cateid='.$cateid)?>" class="gla">管 理</a>
                    <form name="myform" action="<?=site_url('admin/news/VideoList')?>" method="get">
                ...
                <form action="<?=site_url('admin/news/VideoDel')?>" method="post" onSubmit="return checkSubmit(this);">
                <div class="hdbot">
                    <table width="910" border="0" cellspacing="1" cellpadding="0" class="table1 tab">
                      ...
                      <tr>
                        ...
                        <td align="center">
						 <?=$c['title']?>
                         <?php if(!empty($c['simg'])):?><font class="fontt"><a href="<?=base_url($c['simg'])?>" target="_blank" style="color:#F00">图</a></font><?php endif;?>
                        </td>
                        <td align="center"><?=$c["ord"];?></td>
                        <td align="center"><?=date('Y-m-d H:i',$c['addtime']);?></td>
                        <td align="center"><a href="<?=site_url('admin/news/VideoEdit?cateid='.$cateid.'&id='.$c['id'])?>" class="xga">修改</a></td>
                      </tr>
                      <?php endforeach;?>
