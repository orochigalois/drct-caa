<div class="mrbot">
    <div class="mrbot1">
        ...
        <div class="mrnr1">
                ...
                <div class="zxzx_main">
                	<form name="myform"  method="post" action="<?=site_url('admin/news/VideoSave')?>" class="addForm">
                    <table class="table7 table77" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            <td>视频地址：</td>
                            <td>
                         	  <input name="info[v_url]" value="<?=isset($row["v_url"])?$row["v_url"]:'';?>" type="text" class="inputt input3" /> 
                            </td>
                        </tr>
                        <tr>
                            <td>图 片：</td>
                            <td>
                         	  ...
                         	  <input name="Submit2" type="button" class="button1" onclick="uploadpic('simg',270,152)" value="上传" />图片建议尺寸270*152px;
                            </td>
                        </tr>
                        <tr>
